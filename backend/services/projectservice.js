...
export const getTasksByProject = (projectId) => Task.find({ project_id: projectId });
...
export const getTimeEntriesByProject = (projectId) => TimeEntry.find({ project_id: projectId });
export const updateTimeEntry = (id, data) => TimeEntry.findByIdAndUpdate(id, data, { new: true });
export const deleteTimeEntry = (id) => TimeEntry.findByIdAndDelete(id);

// Invoice operations
export const createInvoice = (data) => Invoice.create(data);
export const getInvoicesByProject = (projectId) => Invoice.find({ project_id: projectId });
export const updateInvoice = (id, data) => Invoice.findByIdAndUpdate(id, data, { new: true });
export const deleteInvoice = (id) => Invoice.findByIdAndDelete(id);

// Expense operations
export const createExpense = (data) => Expense.create(data);
export const getExpensesByProject = (projectId) => Expense.find({ project_id: projectId });
export const updateExpense = (id, data) => Expense.findByIdAndUpdate(id, data, { new: true });
