...
export default function StartFree({
  ...
  // dotted pattern for the right half (no images needed)
  ...
  return (
    ...
    >
      {/* ambient glows */}
      <div aria-hidden className="pointer-events-none absolute -left-32 top-0 h-[520px] w-[520px] rounded-full bg-emerald-400/20 blur-3xl" />
      <div aria-hidden className="pointer-events-none absolute -right-24 bottom-[-140px] h-[560px] w-[560px] rounded-full bg-sky-500/20 blur-3xl" />
        ...
        <div className="relative z-10 hidden md:block">
          ...
          >
            ...
            <Bubble
              ...
              style={{
                transform: `translate3d(${hover.x * 0.02}px, ${hover.y * 0.02}px, 0)`,
              }}
            />
            <Target
              className="absolute right-16 top-14"
              style={{
                transform: `translate3d(${hover.x * 0.03}px, ${hover.y * 0.03}px, 0)`,
              }}
            />
            <Person
              className="absolute bottom-0 right-8 h-[72%] w-auto"
              style={{
                transform: `translate3d(${hover.x * 0.01}px, ${hover.y * 0.01}px, 0)`,
              }}
            />
      ...
      {/* responsive mobile illustration (under content) */}
...
function Person({
  ...
  // Minimal friendly figure — pink shirt, tablet; matches modern illustration style
  return (
    <svg
      className={className}
      style={style}
