...
export default function BankingPage() {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Stay on top of your money</h2>
          <button
        ...
        <p className="text-gray-600 mb-6">
          Connect your bank and credit cards to fetch all your transactions. Create, categorize and match these transactions to those you have in Zoho Books.
        </p>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Tab Content */}
      {activeTab === 'overview' && (
        <BankingOverview accounts={accounts} />
      )}
