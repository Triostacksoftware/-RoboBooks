...
const ICON_BUTTONS = [
  { Icon: QuestionMarkCircleIcon, label: 'Instant Helper', badge: null, action: 'help' },
  { Icon: MegaphoneIcon, label: 'Read more', badge: '1', action: 'announcements' },
  { Icon: PlayCircleIcon, label: 'Webinars', badge: null, action: 'webinars' },
  { Icon: DocumentTextIcon, label: 'Robo Notebook', badge: null, action: 'robo-notebook' },
  { Icon: Cog6ToothIcon, label: 'All Extensions', badge: null, action: 'extensions' },
];
...
export default function RightSidebar() {
  ...
  }, [helpPanelOpen, isPinned, announcementsOpen, isAnnouncementsPinned, webinarsOpen, isWebinarsPinned, roboNotebookOpen, isRoboNotebookPinned, extensionsOpen, isExtensionsPinned]);
  ...
  if (helpPanelOpen) {
    ...
    return (
      <>
        ...
        <aside data-settings-utils className="fixed top-14 right-0 bottom-0 flex flex-col items-center bg-white shadow-lg px-4 py-4 select-none z-40 w-20">
        ...
        {/* Help Panel */}
        <aside data-help-panel className="fixed top-14 right-20 bottom-0 w-96 bg-white shadow-lg z-50 flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className={`p-1 rounded transition ${isPinned ? 'bg-blue-100 text-blue-600' : 'text-gray-400 hover:text-gray-600'}`}
              title={isPinned ? 'Unpin panel' : 'Pin panel'}
            >
              <PaperClipIcon className={`w-4 h-4 ${isPinned ? 'rotate-45' : ''}`} />
            </button>
            <h2 className="text-lg font-semibold text-gray-800">Instant Helper</h2>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className={`p-1 rounded-full hover:bg-gray-100 transition ${isPinned ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={isPinned}
              title={isPinned ? 'Panel is pinned - unpin to close' : 'Close panel'}
            >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="font-bold text-black text-lg">{currentModuleContent.title}</h3>
            </div>
            ...
            <div className="bg-white rounded-lg p-3 border border-gray-200">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800">{currentModuleContent.video.title}</p>
                  <p className="text-xs text-gray-500">{currentModuleContent.video.duration}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {currentModuleContent.faq.slice(0, showAllFAQ ? currentModuleContent.faq.length : 5).map((item, index) => (
                <div key={index} className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 cursor-pointer transition">
            ...
            >
              ...
              {showAllFAQ ? <ChevronUpIcon className="w-4 h-4" /> : <ChevronDownIcon className="w-4 h-4" />}
            </button>
          </div>

          {/* Documents Section */}
          <div>
            <h3 className="font-semibold text-gray-800 mb-3">Help Documents</h3>
            <div className="space-y-2">
              {DOCUMENT_ITEMS.slice(0, showAllDocuments ? DOCUMENT_ITEMS.length : 3).map((item, index) => (
                <div key={index} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-50 cursor-pointer transition">
          ...
          <div className="border-t border-gray-200 pt-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-800">Need Assistance?</span>
              </div>
              <button
  ...
  if (announcementsOpen) {
    return (
      <>
        ...
        {/* Announcements Panel */}
        <aside data-announcements-panel className="fixed top-14 right-20 bottom-0 w-96 bg-white shadow-lg z-50 flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            {/* Pin Option */}
            <button
              ...
              className={`p-1 rounded transition ${isAnnouncementsPinned ? 'bg-blue-100 text-blue-600' : 'text-gray-400 hover:text-gray-600'}`}
              title={isAnnouncementsPinned ? 'Unpin panel' : 'Pin panel'}
            >
              <PaperClipIcon className={`w-4 h-4 ${isAnnouncementsPinned ? 'rotate-45' : ''}`} />
            </button>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className={`p-1 rounded-full hover:bg-gray-100 transition ${isAnnouncementsPinned ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={isAnnouncementsPinned}
              title={isAnnouncementsPinned ? 'Panel is pinned - unpin to close' : 'Close panel'}
            >
              <XMarkIcon className="w-5 h-5 text-gray-600" />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 group">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-gray-800 mb-2">Your referrals matter — even more now.</h3>
                <p className="text-sm text-gray-600 mb-4">
                  {expandedAnnouncement === 1 ? (
                    <>
                      Love using Zoho Books? Refer and earn 20% as referral credits on every customer you refer this month. Your contact also receives $100 in wallet credits. There is no limit to how much you can earn—start referring today!
                      <button 
                    ...
                    <>
                      Love using Zoho Books? Refer and earn 20% as referral credits on every customer you refer...
                      <button 
  ...
  if (webinarsOpen) {
    return (
      <>
        ...
        {/* Webinars Panel */}
        <aside data-webinars-panel className="fixed top-14 right-20 bottom-0 w-96 bg-white shadow-lg z-50 flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              {/* Pin Option */}
              <button
                ...
                className={`p-1 rounded transition ${isWebinarsPinned ? 'bg-blue-100 text-blue-600' : 'text-gray-400 hover:text-gray-600'}`}
                title={isWebinarsPinned ? 'Unpin panel' : 'Pin panel'}
              >
                <PaperClipIcon className={`w-4 h-4 ${isWebinarsPinned ? 'rotate-45' : ''}`} />
              </button>
              <h2 className="text-lg font-semibold text-gray-800">Webinars</h2>
            </div>
            <button
              onClick={handleCloseWebinars}
              className={`p-1 rounded-full hover:bg-gray-100 transition ${isWebinarsPinned ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={isWebinarsPinned}
              title={isWebinarsPinned ? 'Panel is pinned - unpin to close' : 'Close panel'}
            >
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center justify-center">
            ...
            <p className="text-gray-600 text-center max-w-xs">
              There are no webinars from Zoho Books at the moment. Check this space regularly to stay updated on the webinars conducted by Zoho Books.
            </p>
          </div>
        </aside>
      </>
  ...
  if (roboNotebookOpen) {
    return (
      <>
        ...
        {/* Robo Notebook Panel */}
        <aside data-robo-notebook-panel className="fixed top-14 right-20 bottom-0 w-96 bg-white shadow-lg z-50 flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              {/* Pin Option */}
              <button
                ...
                className={`p-1 rounded transition ${isRoboNotebookPinned ? 'bg-blue-100 text-blue-600' : 'text-gray-400 hover:text-gray-600'}`}
                title={isRoboNotebookPinned ? 'Unpin panel' : 'Pin panel'}
              >
                <PaperClipIcon className={`w-4 h-4 ${isRoboNotebookPinned ? 'rotate-45' : ''}`} />
              </button>
              <h2 className="text-lg font-semibold text-gray-800">Robo Notebook</h2>
            </div>
            <button
              onClick={handleCloseRoboNotebook}
              className={`p-1 rounded-full hover:bg-gray-100 transition ${isRoboNotebookPinned ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={isRoboNotebookPinned}
              title={isRoboNotebookPinned ? 'Panel is pinned - unpin to close' : 'Close panel'}
            >
              <XMarkIcon className="w-5 h-5 text-red-600" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center justify-center">
            ...
            <p className="text-gray-800 text-center mb-6 max-w-xs">
              Install the Robo Notebook extension to take contextual notes, create checklists, upload images, and add documents from any screen within Robo Books.
            </p>
  ...
  if (extensionsOpen) {
    return (
      <>
        ...
        {/* Extensions Panel */}
        <aside data-extensions-panel className="fixed top-14 right-20 bottom-0 w-96 bg-white shadow-lg z-50 flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              {/* Pin Option */}
              <button
                ...
                className={`p-1 rounded transition ${isExtensionsPinned ? 'bg-blue-100 text-blue-600' : 'text-gray-400 hover:text-gray-600'}`}
                title={isExtensionsPinned ? 'Unpin panel' : 'Pin panel'}
              >
                <PaperClipIcon className={`w-4 h-4 ${isExtensionsPinned ? 'rotate-45' : ''}`} />
              </button>
              <h2 className="text-lg font-semibold text-gray-800">Extensions</h2>
            </div>
            <button
              onClick={handleCloseExtensions}
              className={`p-1 rounded-full hover:bg-gray-100 transition ${isExtensionsPinned ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={isExtensionsPinned}
              title={isExtensionsPinned ? 'Panel is pinned - unpin to close' : 'Close panel'}
            >
              <XMarkIcon className="w-5 h-5 text-red-600" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center justify-center">
            ...
            {/* Message */}
            <p className="text-gray-600 text-center max-w-xs">
              Explore our powerful extensions to enhance your Robo Books experience.
            </p>
              ...
              <div className="bg-gray-100 rounded-lg p-4 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800">Robo Notebook</h4>
                      <p className="text-xs text-gray-500">Take contextual notes, create checklists, and more.</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800">Robo Invoice</h4>
                      <p className="text-xs text-gray-500">Manage your invoices and payments.</p>
                    </div>
                  </div>
                  <button className="p-2 rounded-full hover:bg-gray-200 transition">
                    <Cog6ToothIcon className="w-5 h-5 text-gray-600" />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800">Robo Inventory</h4>
                      <p className="text-xs text-gray-500">Track your inventory and manage stock.</p>
                    </div>
                  </div>
                  <button className="p-2 rounded-full hover:bg-gray-200 transition">
                    <Cog6ToothIcon className="w-5 h-5 text-gray-600" />
