...
export default function CustomersSection() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'comments' | 'transactions' | 'mails' | 'statement'>('overview');
  ...
  const renderTableRow = (customer: Customer) => {
    const isSelected = selectedCustomer && selectedCustomer._id === customer._id;
    return (
      <tr 
        key={customer._id} 
  ...
  return (
    <section className="w-full h-full overflow-auto bg-white text-sm">
      ...
      <div className="flex h-full">
        ...
        <div className={`${selectedCustomer ? 'w-1/3' : 'w-full'} border-r border-gray-200`}>
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white">
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-semibold text-gray-900">Active Customers</h2>
        ...
        {selectedCustomer && (
          <div className="w-2/3 bg-white">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h1 className="text-2xl font-bold text-gray-900">{getCustomerName(selectedCustomer)}</h1>
              <div className="flex items-center gap-2">
                <button className="p-2 hover:bg-gray-100 rounded-md" title="Edit">
              ...
              {activeTab === 'overview' && (
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-gray-900">{getCustomerName(selectedCustomer)}</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-900">{getCustomerName(selectedCustomer)}</h4>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        {selectedCustomer.billingAddress && selectedCustomer.billingAddress.street ? (
                          <div className="text-sm text-gray-600">
                            <p>{selectedCustomer.billingAddress.street}</p>
                            <p>{selectedCustomer.billingAddress.city}, {selectedCustomer.billingAddress.state}</p>
                            <p>{selectedCustomer.billingAddress.country} {selectedCustomer.billingAddress.zipCode}</p>
                          </div>
                        ) : (
                          <button className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                      ...
                      <div>
                        ...
                        {selectedCustomer.shippingAddress && selectedCustomer.shippingAddress.street ? (
                          <div className="text-sm text-gray-600">
                            <p>{selectedCustomer.shippingAddress.street}</p>
                            <p>{selectedCustomer.shippingAddress.city}, {selectedCustomer.shippingAddress.state}</p>
                            <p>{selectedCustomer.shippingAddress.country} {selectedCustomer.shippingAddress.zipCode}</p>
                          </div>
                        ) : (
                          <button className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                      <div>
                        ...
                        <p className="font-medium mt-1">{getCustomerType(selectedCustomer)}</p>
                      </div>
                      <div>
                        <span className="text-gray-500">Default Currency:</span>
                        <p className="font-medium mt-1">{selectedCustomer.currency}</p>
                      </div>
                      <div>
                        ...
                        <p className="font-medium mt-1">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                            ...
                            {selectedCustomer.portalEnabled ? 'Enabled' : 'Disabled'}
                          </span>
                        </p>
                      </div>
                      <div>
                        <span className="text-gray-500">Portal Language:</span>
                        <p className="font-medium mt-1">{selectedCustomer.portalLanguage}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Contact Persons */}
                  <div className="space-y-4">
                    <h4 className="font-medium text-gray-900">CONTACT PERSONS</h4>
                        ...
                        {selectedCustomer.contactPersons.map((person, index) => (
                          <div key={index} className="border rounded-lg p-3">
                            ...
                            <div className="text-sm mt-2">
                              ...
                              <p className="font-medium mt-1">{person.email}</p>
                            </div>
                            <div className="text-sm mt-2">
                              <span className="text-gray-500">Phone:</span>
                              <p className="font-medium mt-1">{person.phone}</p>
                            </div>
                            <div className="text-sm mt-2">
                              <span className="text-gray-500">Designation:</span>
                              <p className="font-medium mt-1">{person.designation}</p>
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  {/* Payment Terms */}
                  <div className="space-y-4">
                    <h4 className="font-medium text-gray-900">Payment due period</h4>
                    <p className="text-sm text-gray-600">{selectedCustomer.paymentTerms}</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-sm">
                      <div>
                        ...
                        <p className="font-medium mt-1">{selectedCustomer.currency} - {selectedCustomer.currency === 'INR' ? 'Indian Rupee' : 'Currency'}</p>
                      </div>
                      <div>
                        <button className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                      ...
                      <div>
                        ...
                        <p className="font-medium mt-1">{formatCurrency(selectedCustomer.receivables)}</p>
                      </div>
                      <div>
                        <span className="text-gray-500">UNUSED CREDITS:</span>
                        <p className="font-medium mt-1">{formatCurrency(selectedCustomer.unusedCredits)}</p>
                      </div>
                    </div>
                  </div>
                   ...
                   <div className="space-y-4">
                     ...
                     <p className="text-xs text-gray-500">This chart is displayed in the organization's base currency.</p>
                     <div className="bg-gray-50 rounded-lg p-4">
                         ...
                         <div className="ml-8 h-32 relative">
                           ...
                           <div className="absolute inset-0 flex flex-col justify-between">
                             {[0, 1, 2, 3, 4, 5].map((line) => (
                               <div key={line} className="border-b border-gray-100 h-0"></div>
                             ))}
                           </div>
                           
                           {/* Chart Bars (empty for now) */}
                           <div className="absolute bottom-0 left-0 right-0 flex justify-between items-end px-2">
                             {['Feb 2025', 'Mar 2025', 'Apr 2025', 'May 2025', 'Jun 2025', 'Jul 2025', 'Aug 2025'].map((month, index) => (
                               <div key={month} className="flex flex-col items-center">
                                 <div className="w-6 bg-gray-200 rounded-t" style={{ height: '4px' }}></div>
                       ...
                       <div className="mt-2 text-left">
                         <p className="text-sm text-gray-600">Total Income (Last 6 Months) - {formatCurrency(0)}</p>
                       </div>
                     </div>
                   </div>
                       ...
                       <div className="space-y-6">
                           ...
                           <div className="ml-12 flex-1">
                             <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                               <div className="flex justify-between items-start mb-2">
                                 <h5 className="font-medium text-gray-900">Contact person added</h5>
                                 <span className="text-xs text-gray-500">06/08/2025 01:05 PM</span>
                               </div>
                               <p className="text-sm text-gray-600">
                                 Contact person {selectedCustomer.firstName} has been created by {getCustomerName(selectedCustomer)}
                               </p>
                             </div>
                           </div>
                         </div>
                         ...
                         <div className="relative flex items-start">
                           ...
                           <div className="ml-12 flex-1">
                             <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                               <div className="flex justify-between items-start mb-2">
                                 <h5 className="font-medium text-gray-900">Contact added</h5>
                                 <span className="text-xs text-gray-500">06/08/2025 01:05 PM</span>
                               </div>
                               <p className="text-sm text-gray-600">
                   ...
                   <div className="space-y-4">
                     ...
                     <div className="space-y-3">
                       <div className="flex justify-between text-sm">
                         <span className="text-gray-500">06/08/2025 01:05 PM</span>
                         <span className="text-gray-900">Contact person added</span>
                       </div>
                       <p className="text-sm text-gray-600">Contact person {selectedCustomer.firstName} has been created by {getCustomerName(selectedCustomer)}</p>
                       
                       <div className="flex justify-between text-sm">
                         <span className="text-gray-500">06/08/2025 01:05 PM</span>
                         <span className="text-gray-900">Contact added</span>
                       </div>
                       <p className="text-sm text-gray-600">Contact created by {getCustomerName(selectedCustomer)}</p>
                     </div>
                   </div>
                </div>
              )}
                 ...
                 <div className="space-y-6">
                       ...
                       <table className="min-w-full">
                         <thead className="bg-gray-50 text-xs text-gray-600 uppercase">
                           <tr>
                             ...
                             <th className="px-4 py-3 text-left">AMOUNT</th>
                             <th className="px-4 py-3 text-left">UNUSED AMOUNT</th>
                           </tr>
                         </thead>
                         <tbody>
                           <tr>
                             <td colSpan={6} className="px-4 py-8 text-center text-gray-500">
                               No payments have been received or recorded yet. - Add Now
                             </td>
                           </tr>
                         </tbody>
                       </table>
                   ...
                   <div className="space-y-2">
                     {[
                       ...
                       <div key={section} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                         <div className="flex items-center gap-2">
                 ...
                 <div className="space-y-4">
                   <div className="bg-white border border-gray-200 rounded-lg p-6">
                     <div className="flex justify-between items-start mb-4">
                       <h4 className="font-medium text-gray-900">System Mails</h4>
                 ...
                 <div className="space-y-4">
                   ...
                   <div className="flex justify-between items-center">
                     ...
                     <div className="flex gap-2">
                       <button className="p-2 hover:bg-gray-100 rounded-md" title="Print">
                         <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   ...
                   <div className="bg-white border border-gray-200 rounded-lg p-6">
                     <div className="space-y-6">
                       {/* Statement Header */}
                       <div className="space-y-2">
                         <h2 className="text-xl font-bold text-gray-900">Customer Statement for {getCustomerName(selectedCustomer)}</h2>
                         <p className="text-sm text-gray-600">From 01/08/2025 To 31/08/2025</p>
                       </div>
                       
                       {/* Recipient and Company Info */}
                       <div className="flex justify-between">
                         <div>
                           <p className="text-sm text-gray-600">To {getCustomerName(selectedCustomer)}</p>
                         </div>
                       ...
                       <div className="space-y-2">
                         <h3 className="text-lg font-bold text-gray-900 underline">Statement of Accounts</h3>
                         <p className="text-sm text-gray-600">01/08/2025 To 31/08/2025</p>
                       </div>
