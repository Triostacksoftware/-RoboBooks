...
export default function DocumentsOverview({ onDocumentUploaded }: DocumentsOverviewProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Organize, store, and access all your business documents in one secure location. 
              Upload, categorize, and share documents effortlessly with Robo Books document management.
            </p>
            <button 
