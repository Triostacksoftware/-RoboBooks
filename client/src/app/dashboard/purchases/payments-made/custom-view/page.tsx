...
const CustomViewPage = () => {
  ...
  const [selectedColumns, setSelectedColumns] = useState<string[]>(['date', 'description', 'amount', 'vendor', 'paymentMethod']);
  ...
  const loadCustomViews = async () => {
    try {
      ...
      // You could implement a view selector here
    } catch (error) {
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">Create Custom View - Payments Made</h1>
          </div>
          <button
