...
const CustomViewPage = () => {
  ...
  const [selectedColumns, setSelectedColumns] = useState<string[]>(['date', 'description', 'amount', 'vendor', 'frequency']);
  ...
  const module = 'recurring-expenses';
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">Create Custom View - Recurring Expenses</h1>
          </div>
          <button
