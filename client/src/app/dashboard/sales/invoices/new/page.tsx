              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-xs text-gray-500 mt-1">You can upload a maximum of 10 files, 10MB each</p>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-medium text-blue-900">Want to get paid faster?</p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm font-medium">₹{formData.subTotal}</span>
                      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium">₹{formData.discountAmount}</span>
                        </div>
                      </div>
                      ...
                      <div className="border-t pt-3">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          />
                          <label htmlFor="tds" className="text-sm text-gray-600">TDS</label>
                          <input
                            type="radio"
                            id="tcs"
                            name="taxType"
                            ...
                            onChange={(e) => setFormData(prev => ({ ...prev, taxType: e.target.value }))}
                          />
                          <label htmlFor="tcs" className="text-sm text-gray-600">TCS</label>
                        </div>
                        <div className="relative">
                          <select className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md">
                            <option>Select a Tax</option>
                          </select>
                          <span className="absolute right-3 top-2 text-sm text-gray-500">{formData.taxAmount}</span>
                        </div>
                      </div>
                      ...
                      <div className="border-t pt-3">
                        <div className="flex justify-between">
                          ...
                          <span className="text-lg font-semibold">₹{formData.total}</span>
                        </div>
                      </div>
                    </div>
                  </div>
