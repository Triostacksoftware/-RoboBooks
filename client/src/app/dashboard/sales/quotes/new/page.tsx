          ...
          <CustomerDetails
            ...
            onFormDataChange={(data) => {
              setFormData((prev) => ({
                ...
                placeOfSupplyState:
                  data.placeOfSupplyState || data.shippingAddress?.state || prev.placeOfSupplyState,
              }));

              if (
                (data.shippingAddress?.state && data.shippingAddress.state !== formData.placeOfSupplyState) ||
                (data.placeOfSupplyState && data.placeOfSupplyState !== formData.placeOfSupplyState)
              ) {
                setTimeout(recalculateAllTotals, 100);
              }
            }}
