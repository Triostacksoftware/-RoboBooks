  ...
  return (
    <div className="w-full relative z-50">
      <div className="w-full flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3 border-b bg-white shadow-sm">
            ...
            <div className="absolute left-0 mt-2 w-72 sm:w-80 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden max-h-[400px] flex flex-col">
              ...
              <div className="overflow-y-auto">
                {filteredStatuses.map((status, idx) => (
                  <div
                    key={idx}
                    onClick={() => console.log(`Selected: ${status}`)}
        ...
        {/* Right: New Button + Ellipsis Menu */}
        <div className="flex items-center gap-2 relative" ref={menuRef}>
          <button
            onClick={() => console.log('Create New Sales Order')}
          ...
          <div className="relative">
            ...
            {menuOpen && (
              <div className="absolute right-0 top-10 bg-white border border-gray-200 rounded-xl shadow-lg w-56 text-sm z-50">
                <div
                ...
                <div
                  onClick={() => console.log('Import Sales Orders')}
                ...
                {/* Sort Submenu */}
                {hoveredSubMenu === 'sort' && (
                  <div className="absolute top-0 right-full bg-white border border-gray-200 rounded-xl shadow-md w-56 z-50">
                ...
                {hoveredSubMenu === 'export' && (
                  <div className="absolute top-[104px] right-full bg-white border border-gray-200 rounded-xl shadow-md w-56 z-50">
                    <div
                      onClick={() => console.log('Export Sales Orders')}
                      className="px-4 py-2 hover:bg-blue-50 text-blue-600 font-medium cursor-pointer transition"
                    >
                      Export Sales Orders
                    </div>
                    <div
