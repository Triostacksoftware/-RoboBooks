...
export const bankingService = {
  ...
  getAccountTransactions: (id, params) => http.get(`/bank-accounts/${id}/transactions`, { params }),
  ...
  reconcileTransaction: (id) => http.patch(`/bank-transactions/${id}/reconcile`),
  categorizeTransaction: (id, data) => http.patch(`/bank-transactions/${id}/categorize`, data),
  getTransactionCategories: () => http.get('/bank-transactions/categories'),
  getTransactionSummary: (params) => http.get('/bank-transactions/summary', { params }),
  ...
  updateReconciliation: (id, data) => http.put(`/bank-reconciliations/${id}`, data),
  updateReconciliationItem: (id, itemId, data) => http.patch(`/bank-reconciliations/${id}/items/${itemId}`, data),
  completeReconciliation: (id) => http.post(`/bank-reconciliations/${id}/complete`),
  autoMatchReconciliation: (id) => http.post(`/bank-reconciliations/${id}/auto-match`),
  getAccountReconciliations: (accountId) => http.get(`/bank-reconciliations/account/${accountId}`),
  ...
  getAccountAnalytics: (accountId, params) => http.get(`/banking/account-analytics/${accountId}`, { params }),
